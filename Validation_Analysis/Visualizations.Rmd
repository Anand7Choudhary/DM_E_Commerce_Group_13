...
ggsave(paste0("../Images/", timestamp_folder, "/AvgRatingScore.png"), plot = rating_by_cat)
...
ggsave(paste0("../Images/", timestamp_folder, "/SalesByCategory.png"), plot = top_categories)
...
ggsave(paste0("../Images/", timestamp_folder, "/Top20Sellers.png"), plot = plot_top_sellers)
...
ggsave(paste0("../Images/", timestamp_folder, "/Top10ProductsRating.png"), plot = revenue_review_plt)
...
ggsave(paste0("../Images/", timestamp_folder, "/PaymentType.png"), plot = paytype_plt)
...
ggsave(paste0("../Images/", timestamp_folder, "/SalesLast3m.png"), plot = revenue_last_3m_plt)
