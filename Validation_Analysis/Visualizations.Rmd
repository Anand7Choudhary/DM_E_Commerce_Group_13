...
ggsave(paste0("../Images/AvgRatingScore_",
...
ggsave(paste0("../Images/SalesByCategory_",
              this_filename_date,"_",
              this_filename_time,".png"))
...
ggsave(paste0("../Images/Top20Sellers_",
              this_filename_date,"_",
              this_filename_time,".png"))
...
#Plot
rev_prod_plt <- ggplot(rev_prod, aes(y = reorder(paste(product_name, product_id), total_revenue), x = total_revenue, fill = as.factor(category_name))) +
  geom_bar(stat = "identity") + labs(x="Sales", y="Product", title = "Top 10 Product Sales", fill = "Category")
...
ggsave(paste0("../Images/Top10Products_",
              this_filename_date,"_",
              this_filename_time,".png"), plot = rev_prod_plt)
```
...
#Plot
revenue_review_plt <- ggplot(review_revenue, aes(y = reorder(paste(product_name,product_id),total_revenue), x = total_revenue, size = avg_rev)) +
  geom_point() +  
  scale_size_continuous(range = c(2, 10)) + labs(title= "Top 10 Sales with Rating",x="Sales", y="Product", , size = "Average Rating")

revenue_review_plt

ggsave(paste0("../Images/Top10ProductsRating_",
              this_filename_date,"_",
              this_filename_time,".png"), plot = revenue_review_plt)
...
ggsave(paste0("../Images/PaymentType_",
              this_filename_date,"_",
              this_filename_time,".png"), plot = paytype_plt)
